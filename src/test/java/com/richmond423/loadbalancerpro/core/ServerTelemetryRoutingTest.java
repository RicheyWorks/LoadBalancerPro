...
class ServerTelemetryRoutingTest {
    ...
    private LoadBalancer balancerForAllocationRegression(boolean shadowEnabled) {
        ...
        com.richmond423.loadbalancerpro.core.Server first = new com.richmond423.loadbalancerpro.core.Server("S1", 20.0, 20.0, 20.0);
        first.setCapacity(80.0);
        com.richmond423.loadbalancerpro.core.Server second = new com.richmond423.loadbalancerpro.core.Server("S2", 10.0, 10.0, 10.0);
