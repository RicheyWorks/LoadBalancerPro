    ...
    void failureRecoveryScenarioUpdatesOnlyReplayLocalServerStateAndRoutesDeterministically() throws Exception {
        try (MockedConstruction<CloudManager> mockedCloudManager =
            ...
            mockMvc.perform(scenarioReplay("""
                    ...
                    .andExpect(jsonPath("$.steps[1].decisionReplayEvidenceReviewerClosurePacket").doesNotExist())
                    .andExpect(jsonPath("$.steps[1].routingResults[0]"
                            + ".decisionReplayEvidenceReviewerClosureRollup").doesNotExist())
                    .andExpect(jsonPath("$.steps[1].routingResults[0]"
                            + ".decisionReplayEvidenceReviewerClosureChecklist").doesNotExist())
                    .andExpect(jsonPath("$.steps[1].routingResults[0]"
                            + ".decisionReplayEvidenceReviewerClosurePacket").doesNotExist())
