...
- Adaptive routing scenarios: [`/adaptive-routing-scenarios.html`](http://localhost:8080/adaptive-routing-scenarios.html), including same-origin summary, drilldown, packet, and gate-evaluation APIs for local synthetic strategy explanations.
...
- Decision Vector contract: [`docs/ENTERPRISE_LAB_DECISION_VECTOR.md`](docs/ENTERPRISE_LAB_DECISION_VECTOR.md).
