...
- [`LOCAL_ARTIFACT_VERIFICATION.md`](docs/LOCAL_ARTIFACT_VERIFICATION.md) documents release-free local checksum, jar manifest/resource inspection, static page verification, demo profile verification, and packaged run commands.
