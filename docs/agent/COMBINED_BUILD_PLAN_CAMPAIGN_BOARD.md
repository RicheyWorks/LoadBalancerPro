...
- Active implementation slot: `L-2.5`; make durability receipts honest and storage failures diagnosable on
  ...
  `11b23f530156cc01e4f4016a48f4051f70593697`. The current-state inventory and implementation seam are pending.
...
| 20 | L-2.5 | L-2.5 | Honest durability and logging | L-2.4 | IN_PROGRESS |
