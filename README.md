...
- [`PROXY_DEMO_STACK.md`](docs/PROXY_DEMO_STACK.md) documents the single Windows/Unix local proxy demo stack path with checked-in demo profiles, two loopback fixture backends, and copyable curl verification.
