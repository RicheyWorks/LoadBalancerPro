...
- Adaptive routing scenarios: [`/adaptive-routing-scenarios.html`](http://localhost:8080/adaptive-routing-scenarios.html).
...
- `/adaptive-routing-scenarios.html` and `GET /api/enterprise-lab/adaptive-routing-scenario-summary` add deterministic local synthetic selected-server distribution evidence from existing routing strategies without live traffic or production benchmark claims.
