...
This design is only a preparation lane for future Compose work. It does not make k6, Bruno, or Toxiproxy automatic. It does not make Docker/k6/Bruno/Toxiproxy platform implementation exist.
