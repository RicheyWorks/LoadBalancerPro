...
Replay snapshots, reconstruction traces, replay capsules, readiness checklists, evidence source maps, boundary summaries, field inventories, null-safety summaries, status rollups, lane navigation summaries, lane dependency maps, and lane reference indexes are read-only lab evidence. They do not execute replay, perform what-if mutation, persist traces, capsules, checklists, source maps, boundary summaries, field inventories, null-safety summaries, status rollups, lane navigation summaries, lane dependency maps, lane reference indexes, or audit logs server-side, recompute scores, retune weights, export/download/share those evidence objects, generate a field-inventory, null-safety, status-rollup, lane-navigation, lane-dependency, or lane-reference-index fingerprint, or add upload/share/download/export/PDF/ZIP functionality.
