...
- Active implementation slot: `L-1.1`; metadata-about-metadata deletion is in progress on
  `codex/l-1-1-remove-metadata-services`.
...
| 12 | L-1.1 | L-1.1 | Delete metadata-about-metadata services | L0 complete | IN_PROGRESS |
