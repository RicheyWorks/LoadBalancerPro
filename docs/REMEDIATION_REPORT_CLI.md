...
These commands require the opt-in Lab Tools artifact. Build it with `mvn -B -P lab -DskipTests package`; the default production JAR intentionally omits offline evidence and simulation CLIs.
