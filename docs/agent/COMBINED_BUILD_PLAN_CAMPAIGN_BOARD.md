...
- Active implementation slot: `P-0.6`; the simulation-core correctness batch is under current-main audit on branch
  `codex/p-0-6-simulation-core-correctness`.
...
| 6 | P-0.6 | P-0.6 | Simulation-core correctness batch | — | IN_PROGRESS |
