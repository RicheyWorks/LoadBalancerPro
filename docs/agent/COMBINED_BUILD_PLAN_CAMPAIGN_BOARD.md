...
- Active implementation slot: `P-0.4`; weight-zero drain and interrupted-retry classification are under
  current-main audit on branch `codex/p-0-4-weight-zero-retry`.
...
| 5 | P-0.4 | P-0.4 | Weight-zero drain and retry classification | — | IN_PROGRESS |
