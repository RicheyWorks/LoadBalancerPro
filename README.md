...
- [`OPERATOR_DEMO_WALKTHROUGH.md`](docs/OPERATOR_DEMO_WALKTHROUGH.md) provides a single local demo path from API health checks through the browser demo, Postman import, evidence training onboarding, and deterministic scorecard grading.
