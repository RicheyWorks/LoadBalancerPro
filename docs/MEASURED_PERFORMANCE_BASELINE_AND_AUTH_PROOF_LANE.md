...
- [`CI_EVIDENCE_GATE_READINESS_LANE.md`](CI_EVIDENCE_GATE_READINESS_LANE.md) explains how these local evidence outputs could become inputs to a future CI evidence gate without enforcing it today.
