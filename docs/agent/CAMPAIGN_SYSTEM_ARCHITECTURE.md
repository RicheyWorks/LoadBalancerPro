...
8. Open a PR with scope, verification, safety audit, and not-proven boundaries.
9. Merge only after current-head remote required checks are complete and successful.
