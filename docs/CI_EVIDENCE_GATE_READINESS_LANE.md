...
- Adaptive scenario runner input: `/adaptive-routing-scenarios.html`, `GET /api/enterprise-lab/adaptive-routing-scenario-summary`, `GET /api/enterprise-lab/adaptive-routing-scenario-detail`, `GET /api/enterprise-lab/adaptive-routing-scenario-evidence-packet`, `GET /api/enterprise-lab/adaptive-routing-scenario-gate-evaluation`, and `GET /api/enterprise-lab/adaptive-routing-strategy-comparison-matrix`
...
- adaptive-routing scenario evidence reports deterministic local synthetic selected-server distribution, explanation drilldowns, a reviewer packet shape, and local pass/warn/fail-style gate-evaluation findings without production benchmark, live traffic, branch-protection, required-check, or active CI enforcement claims;
...
- the local prototype at `/ci-evidence-gate.html`, `GET /api/enterprise-lab/ci-evidence-gate-summary`, and `GET /api/enterprise-lab/adaptive-routing-scenario-gate-evaluation` still reports `NOT_ENFORCED`;
- the adaptive-routing strategy comparison matrix remains local/prototype evidence and not a required CI check;
