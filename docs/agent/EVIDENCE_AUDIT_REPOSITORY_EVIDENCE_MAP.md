...
| Campaign docs | [`docs/agent/EVIDENCE_AUDIT_CAMPAIGN_CONTRACT.md`](../archive/agent-history/EVIDENCE_AUDIT_CAMPAIGN_CONTRACT.md), [`docs/agent/EVIDENCE_AUDIT_CAMPAIGN_BOARD.md`](EVIDENCE_AUDIT_CAMPAIGN_BOARD.md), [`docs/agent/EVIDENCE_AUDIT_CAMPAIGN_CHECKPOINT_TEMPLATE.md`](../archive/agent-history/EVIDENCE_AUDIT_CAMPAIGN_CHECKPOINT_TEMPLATE.md), [`docs/agent/EVIDENCE_AUDIT_CAMPAIGN_FINAL_REPORT_TEMPLATE.md`](../archive/agent-history/EVIDENCE_AUDIT_CAMPAIGN_FINAL_REPORT_TEMPLATE.md) | What is this 20-PR campaign and how are slots counted? | Campaign control plane only; a slot counts only after its PR merges and main CI/CodeQL are green. |
...
| CLI app startup | [`src/main/java/com/richmond423/loadbalancerpro/api/LoadBalancerApiApplication.java`](../../src/main/java/com/richmond423/loadbalancerpro/api/LoadBalancerApiApplication.java), CLI command sources, [`docs/agent/EVIDENCE_AUDIT_CLI_APP_STARTUP_AUDIT.md`](../archive/agent-history/EVIDENCE_AUDIT_CLI_APP_STARTUP_AUDIT.md) | Which CLI modes return before Spring Boot startup, and when does the API server start? | Source-visible app startup and CLI command surfaces plus slot 11 audit note only; slot 11 audits without running CLI commands, starting Spring Boot, changing endpoints, or claiming production readiness. |
...
| Open PR hygiene | [`docs/agent/EVIDENCE_AUDIT_OPEN_PR_HYGIENE.md`](../archive/agent-history/EVIDENCE_AUDIT_OPEN_PR_HYGIENE.md) | Which unrelated open PRs need human hygiene review? | Audit note only; it does not close, rebase, edit, or merge unrelated PRs. |
