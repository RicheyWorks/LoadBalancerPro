...
- adaptive-routing scenario evidence reports deterministic local synthetic selected-server distribution, explanation drilldowns, and a reviewer packet shape without production benchmark or live traffic claims;
