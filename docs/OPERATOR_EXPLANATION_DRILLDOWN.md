...
Replay snapshots, reconstruction traces, replay capsules, readiness checklists, evidence source maps, boundary summaries, field inventories, null-safety summaries, status rollups, lane navigation summaries, and lane dependency maps are read-only lab evidence. They do not execute replay, perform what-if mutation, persist traces, capsules, checklists, source maps, boundary summaries, field inventories, null-safety summaries, status rollups, lane navigation summaries, lane dependency maps, or audit logs server-side, recompute scores, retune weights, export/download/share those evidence objects, generate a field-inventory, null-safety, status-rollup, lane-navigation, or lane-dependency fingerprint, or add upload/share/download/export/PDF/ZIP functionality.
