...
- adaptive-routing scenario evidence reports deterministic local synthetic selected-server distribution without production benchmark or live traffic claims;
