...
- I want the shortest public-facing overview: start with [`EXECUTIVE_SUMMARY.md`](EXECUTIVE_SUMMARY.md), then use [`PRODUCTION_READINESS_SUMMARY.md`](PRODUCTION_READINESS_SUMMARY.md) for the production-candidate snapshot and [`DEMO_WALKTHROUGH.md`](DEMO_WALKTHROUGH.md) for a local demo script.
...
- I want to understand container publishing/signing status: start with [`CONTAINER_SIGNING_DECISION_RECORD.md`](CONTAINER_SIGNING_DECISION_RECORD.md).
...
- I want to configure enterprise OAuth2 role claims: start with [`IDP_CLAIM_MAPPING_EXAMPLES.md`](IDP_CLAIM_MAPPING_EXAMPLES.md), then inspect `OAuth2AuthorizationTest`.
...
8. CI evidence: inspect the latest successful CI, CodeQL, Dependency Review, `jacoco-coverage-report`, `packaged-artifact-smoke`, and `loadbalancerpro-sbom` artifacts.
...
| Is container publication/signing implemented? | Container decision record and Dockerfile evidence | [`CONTAINER_SIGNING_DECISION_RECORD.md`](CONTAINER_SIGNING_DECISION_RECORD.md), [`CONTAINER_DEPLOYMENT.md`](CONTAINER_DEPLOYMENT.md) | Dockerfile, prod-profile default, runtime API-key requirement, digest-pinned bases, CI Docker smoke, Trivy scan | Current container posture is local build/run plus CI smoke; future registry, tag, digest, signing, attestation, scan, rollback, and retention decisions are explicit gates | Published registry image, cosign signature, container attestation, Kubernetes deployment, or release image support |
...
| Should the next release be JAR/docs-first or container-based? | Two-track release decision summary | [`RELEASE_READINESS_DECISION_SUMMARY.md`](RELEASE_READINESS_DECISION_SUMMARY.md), [`RELEASE_INTENT_REVIEW.md`](RELEASE_INTENT_REVIEW.md), [`CONTAINER_REGISTRY_SIGNING_ROLLOUT.md`](CONTAINER_REGISTRY_SIGNING_ROLLOUT.md) | Recommended `v2.5.0` JAR/docs-first release intent, container rollout cost/gates, and remaining non-certification limits | Reviewers can choose JAR/docs-first now after explicit authorization or defer container distribution until registry/signing gates are implemented | Actual release publication, container publication, or production certification |
| Can a release candidate be rehearsed without publishing? | Dry-run packet and checklist | [`RELEASE_CANDIDATE_DRY_RUN_PACKET.md`](RELEASE_CANDIDATE_DRY_RUN_PACKET.md), [`RELEASE_INTENT_REVIEW.md`](RELEASE_INTENT_REVIEW.md), [`RELEASE_CANDIDATE_DRY_RUN.md`](RELEASE_CANDIDATE_DRY_RUN.md) | Current-main packet script, release-intent review packet, reviewer packet template, go/no-go table | CI artifacts, local verification, SBOM, checksums, security gates, jar smoke, status UI, demos, and the recommended `v2.5.0` JAR/docs-first human decision map into ignored review evidence | Any tag, GitHub Release, asset upload, registry image, or container signature |
...
5. Open [`RELEASE_READINESS_DECISION_SUMMARY.md`](RELEASE_READINESS_DECISION_SUMMARY.md), [`RELEASE_CANDIDATE_DRY_RUN_PACKET.md`](RELEASE_CANDIDATE_DRY_RUN_PACKET.md), [`RELEASE_INTENT_REVIEW.md`](RELEASE_INTENT_REVIEW.md), and [`RELEASE_CANDIDATE_DRY_RUN.md`](RELEASE_CANDIDATE_DRY_RUN.md) for the release-free decision, packet, human decision review, and go/no-go checklist.
...
4. Generate or fill out [`RELEASE_CANDIDATE_DRY_RUN_PACKET.md`](RELEASE_CANDIDATE_DRY_RUN_PACKET.md), prepare [`RELEASE_INTENT_REVIEW.md`](RELEASE_INTENT_REVIEW.md), then complete [`RELEASE_CANDIDATE_DRY_RUN.md`](RELEASE_CANDIDATE_DRY_RUN.md) and the review packet template.
