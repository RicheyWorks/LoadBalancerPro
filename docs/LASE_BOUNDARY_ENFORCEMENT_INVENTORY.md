...
| `AdaptiveRoutingScenarioEvidencePacket`, `AdaptiveRoutingScenarioEvidencePacketBuilder`, `AdaptiveRoutingScenarioEvidenceSection` | `core` | `evidence` | MEDIUM | They produce scenario evidence packets from shared experiment fixtures and comparison results. | Evidence packets must stay reviewer metadata unless future gates approve more. | Runtime evidence behavior. |
