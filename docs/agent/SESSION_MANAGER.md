...
- Next action: commit the locally green scoped diff, open the PR, record its number, then require exact-head CI/CodeQL and the one-hour workflow-dispatch soak before merge
