...
- [`CI_EVIDENCE_GATE_READINESS_LANE.md`](docs/CI_EVIDENCE_GATE_READINESS_LANE.md) prepares a future local-evidence CI gate without changing required checks, branch protection, rulesets, or GitHub settings.
