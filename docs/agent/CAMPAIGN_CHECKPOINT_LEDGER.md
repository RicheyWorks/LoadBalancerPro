...
Use [`SESSION_MANAGER.md`](SESSION_MANAGER.md) for the active checkpoint, [`FAILURE_LOG.md`](FAILURE_LOG.md) for unresolved material blockers and reusable lessons, and [`COMBINED_BUILD_PLAN_CAMPAIGN_SLOTS.json`](COMBINED_BUILD_PLAN_CAMPAIGN_SLOTS.json) for slot state.
