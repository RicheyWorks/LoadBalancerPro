...
- `v2.4.2` is the dependency-maintenance release baseline for `org.json:json` and AWS SDK v2 BOM updates. In `RicheyWorks/LoadBalancerPro`, GitHub Release publishing remains a manual step after release artifact workflow verification.
