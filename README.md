...
- [`REMEDIATION_REPORT_CLI.md`](docs/REMEDIATION_REPORT_CLI.md) documents offline Markdown/JSON remediation report generation, incident ZIP bundle export, deterministic literal redaction, SHA-256 checksum manifest verification, local checksum-chained CLI audit logs, local evidence inventory catalogs, and evidence catalog diff reports from saved evaluation or replay JSON.
