...
- `MAIN_GREEN` implementation slots: 9 / 49.
...
- Active implementation slot: `L-0.5`; stable mocked-cloud ASG identity and restart reconciliation are under
  current-main audit on branch `codex/l-0-5-stable-mocked-asg-ownership`.
...
| 10 | L-0.5 | L-0.5 | Stable mocked-cloud ASG ownership | SEC-DEFAULT-DENY | IN_PROGRESS |
