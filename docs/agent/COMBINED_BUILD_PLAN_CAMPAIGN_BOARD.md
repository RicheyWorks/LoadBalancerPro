...
- Active implementation slot: `L-0.3`; CLI integer-prompt abort and mutation safety are under current-main audit on
...
| 8 | L-0.3 | L-0.3 | Non-mutating CLI abort | SEC-DEFAULT-DENY | IN_PROGRESS |
