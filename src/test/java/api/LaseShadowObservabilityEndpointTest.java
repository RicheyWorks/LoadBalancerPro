    ...
    void allocationRecordsShadowEventVisibleThroughEndpointWithoutCloudCalls() throws Exception {
        try (MockedConstruction<CloudManager> mockedCloudManager = Mockito.mockConstruction(CloudManager.class)) {
            ...
            mockMvc.perform(get("/api/lase/shadow"))
                ...
                .andExpect(jsonPath("$.summary.recommendationCounts").isMap())
                .andExpect(jsonPath("$.summary.networkSummary.averageTimeoutRate", closeTo(0.0, 0.001)))
                .andExpect(jsonPath("$.summary.networkSummary.averageRetryRate", closeTo(0.0, 0.001)))
                .andExpect(jsonPath("$.summary.networkSummary.averageConnectionFailureRate", closeTo(0.0, 0.001)))
                .andExpect(jsonPath("$.summary.networkSummary.maxLatencyJitterMillis", closeTo(0.0, 0.001)))
                .andExpect(jsonPath("$.summary.networkSummary.recentErrorBurstCount", is(0)))
                .andExpect(jsonPath("$.summary.networkSummary.totalRequestTimeoutCount", is(0)))
                ...
                .andExpect(jsonPath("$.recentEvents[0].networkAwarenessSignal.timeoutRate", closeTo(0.0, 0.001)))
                .andExpect(jsonPath("$.recentEvents[0].networkAwarenessSignal.retryRate", closeTo(0.0, 0.001)))
                .andExpect(jsonPath("$.recentEvents[0].networkAwarenessSignal.connectionFailureRate", closeTo(0.0, 0.001)))
                .andExpect(jsonPath("$.recentEvents[0].networkAwarenessSignal.latencyJitterMillis", closeTo(0.0, 0.001)))
                .andExpect(jsonPath("$.recentEvents[0].networkAwarenessSignal.recentErrorBurst", is(false)))
                .andExpect(jsonPath("$.recentEvents[0].networkAwarenessSignal.requestTimeoutCount", is(0)))
                .andExpect(jsonPath("$.recentEvents[0].networkRiskScore", closeTo(0.0, 0.001)))
