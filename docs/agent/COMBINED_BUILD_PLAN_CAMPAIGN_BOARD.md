...
- Active implementation slot: `P-0.4`; weight-zero drain and interrupted-retry classification are locally green
  on branch `codex/p-0-4-weight-zero-retry` and await one exact-head PR.
...
| 5 | P-0.4 | P-0.4 | Weight-zero drain and retry classification | — | LOCAL_GREEN |
