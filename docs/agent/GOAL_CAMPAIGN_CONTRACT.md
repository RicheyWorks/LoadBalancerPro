...
Use this contract with README.md, AGENTS.md, BUILD_CONTRACT.md, VERIFICATION_PROTOCOL.md, GOAL_MODE_LONG_RUN_PROTOCOL.md, SESSION_MANAGER.md, FAILURE_LOG.md, GOAL_CAMPAIGN_BOARD.md, GOAL_CAMPAIGN_BUILD_CONTRACT_EXAMPLE.md, GOAL_CAMPAIGN_SESSION_CHECKPOINT_EXAMPLES.md, GOAL_CAMPAIGN_FAILURE_RECOVERY_EXAMPLES.md, GOAL_CAMPAIGN_VERIFICATION_PROTOCOL_REFINEMENT.md, GOAL_CAMPAIGN_PR_TEMPLATE.md, GOAL_CAMPAIGN_CHECKPOINT_TEMPLATE.md, and GOAL_CAMPAIGN_FINAL_REPORT_TEMPLATE.md.
