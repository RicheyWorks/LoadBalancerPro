...
Checkpoint: PR 3 local verification completed
...
Next campaign action: run diff checks, enterprise lab package smoke, then open PR 3.
...
SHA: a405c3aeb54d309a69228a5dee2ea663faac0322
